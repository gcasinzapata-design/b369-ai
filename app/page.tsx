...
export default function Home(){
  return (<div className="space-y-8">
    <section className="brand-hero"><h1 className="text-3xl font-bold">Agente IA · Buscador y Tasador</h1>
      <p className="mt-2 text-gray-200 max-w-2xl">Resultados y tasaciones con comparables cercanos. Look & feel limpio, acento teal y navegación simple.</p>
