...
export default function Resultados() {
  ...
  useEffect(() => {
    fetch('/mock.json').then((r) => r.json()).then(setItems)
  }, [])
              ...
              <div className="p-3 space-y-2">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="flex gap-2">
                    {it.url && (
                      <a href={it.url} target="_blank" className="text-blue-600">
                        Anuncio →
                      </a>
                    )}
                    <a
                      href={`/tasador?area_m2=${it.m2}&direccion=${encodeURIComponent(it.titulo)}`}
